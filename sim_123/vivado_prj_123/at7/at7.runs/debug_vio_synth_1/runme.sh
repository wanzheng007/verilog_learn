...
HD_PWD='D:/Laboratory/verilog_learn/sim_123/vivado_prj_123/at7/at7.runs/debug_vio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debug_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debug_vio.tcl
